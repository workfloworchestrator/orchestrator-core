...
from test.integration_tests.search.llm.fixtures import TEST_PRODUCT, TEST_SUBSCRIPTIONS
from test.integration_tests.search.llm.helpers import index_subscription, load_ground_truth
...
def maybe_record_ground_truth(request, worker_id, database):
    ...
    from test.integration_tests.search.llm.scripts.record_ground_truth import record_ground_truth
...
def maybe_run_benchmark(request, worker_id, database):
    ...
    from test.integration_tests.search.llm.scripts.benchmark.benchmark import run_benchmark
