...
async def reindex_with_model(model_config, target_dimension: int, console) -> None:
    ...
    from test.integration_tests.search.llm.fixtures import TEST_SUBSCRIPTIONS
    from test.integration_tests.search.llm.helpers import index_subscription
...
async def benchmark_single_model(
    ...
    from test.integration_tests.search.llm.helpers import ModelConfig, load_benchmark_queries
    from test.integration_tests.search.llm.scripts.benchmark.benchmark import BenchmarkResult
    from test.integration_tests.search.llm.scripts.benchmark.metrics import (
