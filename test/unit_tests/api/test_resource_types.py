...
def test_save_resource_type(seed, test_client):
    ...
    response = test_client.post(
        "/api/resource_types/", data=json_dumps(body), headers={"Content_Type": "application/json"}
    )
...
def test_save_invalid_resource_type(seed, test_client):
    response = test_client.post(
        "/api/resource_types/", data=json_dumps({}), headers={"Content_Type": "application/json"}
    )
...
def test_delete_resource_type(seed, test_client):
    ...
    test_client.post("/api/resource_types/", data=json_dumps(body), headers={"Content_Type": "application/json"})
