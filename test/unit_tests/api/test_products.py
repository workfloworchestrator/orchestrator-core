...
DEPENDENT_ON_SUBSCRIPTION_ID = uuid4()
...
def seed():
    ...
    values = [
        SubscriptionInstanceValueTable(resource_type=port_subscription_id, value=str(DEPENDENT_ON_SUBSCRIPTION_ID))
    ]
    ...
    dependent_on_subscription = SubscriptionTable(
        subscription_id=DEPENDENT_ON_SUBSCRIPTION_ID,
        description="desc",
        status="active",
        insync=True,
        product=msp_product,
    ...
    db.session.add(dependent_on_subscription)
