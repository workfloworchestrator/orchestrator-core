...
def test_save_product_block(seed, test_client):
    ...
    response = test_client.post(
        "/api/product_blocks/", data=json_dumps(body), headers={"Content_Type": "application/json"}
    )
...
def test_save_invalid_product_block(seed, test_client):
    response = test_client.post(
        "/api/product_blocks/", data=json_dumps({}), headers={"Content_Type": "application/json"}
    )
...
def test_delete_product_block(seed, test_client):
    ...
    test_client.post("/api/product_blocks/", data=json_dumps(body), headers={"Content_Type": "application/json"})
