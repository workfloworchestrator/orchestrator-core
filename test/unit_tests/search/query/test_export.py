"""Tests for orchestrator.search.query.export -- export data fetching for subscriptions, workflows, products, and processes."""
...
def test_fetch_subscription_single_row_all_fields_populated():
...
def test_fetch_subscription_none_date_fields_returned_as_none():
...
def test_fetch_subscription_id_cast_to_string():
...
def test_fetch_subscription_empty_entity_ids_returns_empty_list():
...
def test_fetch_subscription_multiple_rows_returned():
...
def test_fetch_workflow_single_no_products():
...
def test_fetch_workflow_with_multiple_products():
...
def test_fetch_workflow_none_created_at_returns_none():
...
def test_fetch_workflow_empty_entity_ids_returns_empty_list():
    """Empty entity_ids list produces an empty result."""
    mock_scalars = MagicMock()
...
def test_fetch_workflow_single_product_no_trailing_comma():
...
def test_fetch_product_single_all_fields_populated():
...
def test_fetch_product_none_created_at_returns_none():
    """created_at=None produces None in the output dict."""
...
def test_fetch_product_id_cast_to_string():
...
def test_fetch_product_empty_entity_ids_returns_empty_list():
    """Empty entity_ids list produces an empty result."""
    mock_scalars = MagicMock()
    mock_scalars.all.return_value = []
...
def test_fetch_product_multiple_returned():
...
def test_fetch_process_single_all_fields_populated():
...
def test_fetch_process_workflow_none_returns_none_for_workflow_name():
...
def test_fetch_process_none_date_fields_returned_as_none():
...
def test_fetch_process_id_cast_to_string():
...
def test_fetch_process_empty_entity_ids_returns_empty_list():
    """Empty entity_ids list produces an empty result."""
    mock_scalars = MagicMock()
    mock_scalars.all.return_value = []
...
def test_fetch_process_is_task_true_preserved():
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            ...
            "orchestrator.search.query.export.fetch_subscription_export_data",
            id="subscription",
        ),
        pytest.param(
            EntityType.WORKFLOW,
            "orchestrator.search.query.export.fetch_workflow_export_data",
            id="workflow",
        ),
        pytest.param(
            EntityType.PRODUCT,
            "orchestrator.search.query.export.fetch_product_export_data",
            id="product",
        ),
        pytest.param(
            EntityType.PROCESS,
            "orchestrator.search.query.export.fetch_process_export_data",
            id="process",
        ),
    ],
)
def test_fetch_export_data_dispatches_to_correct_function(entity_type: EntityType, patch_target: str):
...
def test_fetch_export_data_unsupported_entity_type_raises_value_error():
