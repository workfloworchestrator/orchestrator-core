...
In this document we'll help you upgrade your orchestrator application from orchestrator-core 1.3 to 2.0.
...
There are 2 different use cases of `SubscriptionInstanceList` that can be changed as follows.
...
=== "`orchestrator-core` ≥ 5.0"
    ...
    from orchestrator.core.types import SubscriptionLifecycle, UUIDstr
