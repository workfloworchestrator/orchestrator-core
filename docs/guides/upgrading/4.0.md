...
Everyone who is upgrading to >= 4.7.0 needs to take action. Your previous schedules will exist but will be removed
on the next runtime because the schedule code has been removed.
