...
In this document we describe the steps that should be taken when upgrading from `orchestrator-core` v3 to v4.
...
for [validation workflows](../../getting-started/workflows.md#validate).
