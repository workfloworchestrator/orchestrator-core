...
In particular, your implementation's `migrations/env.py` will likely need to be upgraded
to retrieve the un-redacted Postgres DSN:
...
config.set_main_option(
    "sqlalchemy.url",
    str(app_settings.DATABASE_URI.get_secret_value()),
)
```
