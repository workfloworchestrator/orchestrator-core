...
NOTE: Previously custom settings whose names contained the string "secret" or "password" would automatically be masked.  This is no longer the case, and you should now use the type `SecretStr` for these values instead.
