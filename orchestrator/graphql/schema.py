...
from orchestrator.graphql.resolvers.scheduled_jobs import resolve_scheduled_jobs
...
class OrchestratorQuery:
    ...
    scheduled_jobs: Connection[ScheduledJobGraphql] = authenticated_field(
        resolver=resolve_scheduled_jobs, description="Returns scheduled job information"
    )
