...
from orchestrator.core.cli.generator.generator.translations import add_workflow_translations
from orchestrator.core.cli.generator.generator.validations import get_validations
...
def insert_lazy_workflow_instances(environment: Environment, config: dict, writer: Callable) -> None:
    ...
    if path.exists():
        ...
        import_statement = "from orchestrator.core.workflows import LazyWorkflowInstance\n\n"
