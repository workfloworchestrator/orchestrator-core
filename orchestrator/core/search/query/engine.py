...
async def _apply_session_settings(db_session: AsyncSession, settings: Sequence[SessionSetting]) -> None:
...
async def _execute_search(
    ...
    await _apply_session_settings(db_session, retriever.session_settings)
